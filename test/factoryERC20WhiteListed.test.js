...
const PodERC20Factory = artifacts.require('PRIVIPodERC20FactoryWhiteListed');
...
contract('PRIVI Pod Factory ERC20', (accounts) => {
    ...
    * **********************************************************************/
    ...
    it('createPod(): should create POD if admin add as moderator', async () => {
        await podERC20Factory.addModerator(hacker, {from: admin});
        podERC20Factory.createPod(
            '4',            // pod id
            'Test3',        // pod token name
            'TST3', // pod symbol
