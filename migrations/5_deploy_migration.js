...
module.exports = async function (deployer, networks, accounts) {
	...
	await deployer.deploy(SwapManager, bridgeManagerContract.address, pRIVIPodERC20FactoryContract.address, pRIVIPodERC721FactoryContract.address, pRIVIPodERC1155FactoryContract.address);
};
