...
module.exports = async function (deployer, networks, accounts) {
		...
		const swapREGISTER_ROLE = await swapManagerContract.REGISTER_ROLE();
		const swapTRANSFER_ROLE = await swapManagerContract.TRANSFER_ROLE();

		console.log('Granting swap manager roles', swapREGISTER_ROLE, swapTRANSFER_ROLE, 'to', ETH_PRIVI_ADDRESS);

		await swapManagerContract.grantRole(swapREGISTER_ROLE, ETH_PRIVI_ADDRESS);
